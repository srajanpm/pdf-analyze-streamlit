...
def main():
    ...
    <div style="display: flex; align-items: center; margin-left: 0;">
    <p><h1 style="display: inline-block;">Youtube Videos</h1></p>
    </div>
    """,
    unsafe_allow_html=True,
        )
    ...
    url = st.text_input("YT Url", placeholder="Enter your youtube url here...") or st.button(
            "Submit"
        )
